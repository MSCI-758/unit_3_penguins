...
newdata = gentoo %>% 
  expand(body_mass_g) %>% # Full range of body mass data (gets rid of other variables and repeated body mass values) ## or just use select(body_mass_g)
...
lm_gentoo_3_predict = lm_gentoo_3 %>%
  augment(newdata = newdata, se_fit=TRUE, interval="confidence")  # ?augment.lm
